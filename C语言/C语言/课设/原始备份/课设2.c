...
void xiougai(struct tongxunlu txl[],int e)				//修改主函数
{
	...
	else
	{
		...
		if(k==1)
		{
			...
			{
				case '1':system("cls");
						txl[weizhi[0]]=bhxiougai(txl,e,weizhi[(int)xz-49]);
						break;
				case '2':system("cls");
						txl[weizhi[0]]=xmxiougai(txl[weizhi[0]]);
						break;
				case '3':system("cls");
						txl[weizhi[0]]=xnxiougai(txl[weizhi[0]]);
						break;
				case '4':system("cls");
						txl[weizhi[0]]=zzxiougai(txl[weizhi[0]]);
						break;
				case '5':system("cls");
						txl[weizhi[0]]=sjxiougai(txl[weizhi[0]]);
						break;
				case '6':system("cls");
						txl[weizhi[0]]=qbxiougai(txl,e,weizhi[(int)xz-49]);
						break;
			}
		}
		if(k>1)
		{
			...
			{
				case '1':system("cls");
						txl[weizhi[(int)xz-49]]=bhxiougai(txl,e,weizhi[(int)xz-49]);
						break;
				case '2':system("cls");
						txl[weizhi[(int)xz-49]]=xmxiougai(txl[weizhi[(int)xz-49]]);
						break;
				case '3':system("cls");
						txl[weizhi[(int)xz-49]]=xnxiougai(txl[weizhi[(int)xz-49]]);
						break;
				case '4':system("cls");
						txl[weizhi[(int)xz-49]]=zzxiougai(txl[weizhi[(int)xz-49]]);
						break;
				case '5':system("cls");
						txl[weizhi[(int)xz-49]]=sjxiougai(txl[weizhi[(int)xz-49]]);
						break;
				case '6':system("cls");
						txl[weizhi[(int)xz-49]]=qbxiougai(txl,e,weizhi[(int)xz-49]);
						break;
			}
			free(xuhao);
		}
