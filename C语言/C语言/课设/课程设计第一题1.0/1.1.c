...
void menu(void);
void eatline(void);
struct gongren chuangjian(struct gongren gong[],int e);
void chaxun(struct gongren gong[],int e);
void ghchaxun(struct gongren gong[],int e);
void xmchaxun(struct gongren gong[],int e);
int shanchu(struct gongren gong[],int e);
void xiougai(struct gongren gong[],int e);
void huizong(struct gongren gong[],int e);
void xianshi(struct gongren gong[],int e);
struct gongren
{
	char gongh[11];
	char xingming[10];
...
struct gongren chuangjian(struct gongren gong[],int e)//工号自动生成，应该会跟好一些
{
	int flag=0,flag1=0;
	int i;
	struct gongren xgong;
