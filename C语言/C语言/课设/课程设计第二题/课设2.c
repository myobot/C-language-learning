...
void menu2(void);
void eatline(void);
struct tongxunlu chuangjian(struct tongxunlu txl[],int e);
void tianjia(struct tongxunlu txl[],int e);
void xianshi(struct tongxunlu txl[],int e);		   //显示主函数
void dangexianshi(struct tongxunlu txl[],int e);   //显示函数
void zhuzhaixianshi(struct tongxunlu txl[],int e); //显示函数
void shoujixianshi(struct tongxunlu txl[],int e);  //显示函数
void quanbuxianshi(struct tongxunlu txl[],int e);  //显示函数
void chaxun(struct tongxunlu txl[],int e); 
void xiougai(struct tongxunlu txl[],int e);					 //修改主函数
struct tongxunlu bhxiougai(struct tongxunlu txl[],int e,int weizhi);    //编号修改函数
struct tongxunlu xmxiougai(struct tongxunlu);		 	 //姓名修改函数
struct tongxunlu xnxiougai(struct tongxunlu);			 //性别年龄修改函数
struct tongxunlu zzxiougai(struct tongxunlu);			 //住宅修改函数
struct tongxunlu sjxiougai(struct tongxunlu);			 //手机修改函数
struct tongxunlu qbxiougai(struct tongxunlu txl[],int e,int weizhi);	//全部修改函数
int shanchu(struct tongxunlu txl[],int e);					//删除主函数
void zzshanchu(struct tongxunlu *txl,int weizhi);
void sjshanchu(struct tongxunlu *txl,int weizhi);
int qbshanchu(struct tongxunlu *txl,int weizhi,int e);
struct tongxunlu
{
	char bianhao[11];
	char xingming[10];
...
struct tongxunlu chuangjian(struct tongxunlu txl[],int e)          //创建函数
{
	int i,flag;
	char zzxz,sjxz;
	...
	if(e==0)
	{
		gets(xtxl.bianhao);fflush(stdin);
	}
	else
	{
		while(1)
	...
	printf("现在请输入该朋友的姓名\n");
	gets(xtxl.xingming);fflush(stdin);
	printf("现在请输入该朋友的性别\n");
	gets(xtxl.xingbie);fflush(stdin);
	puts("现在请输入该朋友的年龄");
...
//		scanf("%d",&xtxl.nianling);
	...
	if(zzxz=='y')
	{
		...
		gets(xtxl.zhuzhai);fflush(stdin);
		fflush(stdin);
	}
	printf("是否有该朋友的手机号码?\n输入 y 有,输入 n 无\n");
	sjxz=getchar();
	...
	if(sjxz=='y')
	{
		...
		for(i=0;i<4;i++)
		{
			...
			gets(xtxl.shouji[i]);fflush(stdin);
			xtxl.sjgeshu++;
			if(i!=3)	
			{
...
void tianjia(struct tongxunlu txl[],int e)//           添加函数
{
	int i,k=0,flag4=0,flag1=0,flag2=0,flag3=0;
	int weizhi=-1;
...
/*		if(weizhi==-1)
		...
		if(weizhi!=-1)
		{
			...
			if(txl[weizhi].zhuzhai[0]=='\0'&&txl[weizhi].sjgeshu<4&&flag1==0)
			{
				while(1)
				{
			...
			if(txl[weizhi].zhuzhai[0]!='\0'&&txl[weizhi].sjgeshu<4&&flag1==0&&flag2==0)
			{
...
void dangexianshi(struct tongxunlu txl[],int e)                //单个显示函数
{
	int i,j;
	char xz;
	char *xuhao;
...
void zhuzhaixianshi(struct tongxunlu txl[],int e)                //住宅号码显示函数
{
	int i;
...
void quanbuxianshi(struct tongxunlu txl[],int e)                //全部显示函数
{
	int i,j;
	for(i=0;i<e;i++)
	{
...
void chaxun(struct tongxunlu txl[],int e)                  //查询函数
{
	int i,j,k,weizhi[8];
	char xz;
	...
	else
	{
		...
		if(k==1)
		{
			while(1)
			{
				...
				{
					case '1':system("cls");
							txl[weizhi[0]]=bhxiougai(txl,e,weizhi[(int)xz-49]);system("pause");system("cls");
							break;
					case '2':system("cls");
							txl[weizhi[0]]=xmxiougai(txl[weizhi[0]]);system("pause");system("cls");
							break;
					case '3':system("cls");
							txl[weizhi[0]]=xnxiougai(txl[weizhi[0]]);system("pause");system("cls");;
							break;
					case '4':system("cls");
							txl[weizhi[0]]=zzxiougai(txl[weizhi[0]]);system("pause");system("cls");
							break;
					case '5':system("cls");
							txl[weizhi[0]]=sjxiougai(txl[weizhi[0]]);system("pause");system("cls");
							break;
					case '6':system("cls");
							txl[weizhi[0]]=qbxiougai(txl,e,weizhi[(int)xz-49]);system("pause");system("cls");
							break;
					case '0':flag++;break;
				}
				if(flag>0)
		...
		if(k>1)
		{
			...
			while(1)
			{
				...
				xuanxiang=getchar();
				eatline();
				while(strchr("1234560",xuanxiang)==NULL)
				{
					puts("请重新输入真确选项!  如 1、 2、 3、...");
					xuanxiang=getchar();
					eatline();
				...
				{
					case '1':system("cls");
							txl[weizhi[(int)xz-49]]=bhxiougai(txl,e,weizhi[(int)xz-49]);system("pause");system("cls");
							break;
					case '2':system("cls");
							txl[weizhi[(int)xz-49]]=xmxiougai(txl[weizhi[(int)xz-49]]);system("pause");system("cls");
							break;
					case '3':system("cls");
							txl[weizhi[(int)xz-49]]=xnxiougai(txl[weizhi[(int)xz-49]]);system("pause");system("cls");
							break;
					case '4':system("cls");
							txl[weizhi[(int)xz-49]]=zzxiougai(txl[weizhi[(int)xz-49]]);system("pause");system("cls");
							break;
					case '5':system("cls");
							txl[weizhi[(int)xz-49]]=sjxiougai(txl[weizhi[(int)xz-49]]);system("pause");system("cls");
							break;
					case '6':system("cls");
							txl[weizhi[(int)xz-49]]=qbxiougai(txl,e,weizhi[(int)xz-49]);system("pause");system("cls");
							break;
						case '0':flag++;break;
				}
				if(flag>0)
...
struct tongxunlu xmxiougai(struct tongxunlu txl)		 	 //姓名修改函数
{
	int flag;
...
struct tongxunlu xnxiougai(struct tongxunlu txl)			 //性别年龄修改函数
{
	int nianling,flag;
...
struct tongxunlu zzxiougai(struct tongxunlu txl)			 //住宅修改函数
{
	int flag;
...
struct tongxunlu sjxiougai(struct tongxunlu txl)			 //手机修改函数
{
	int flag,flag1,i;
	char *xuhao;
...
int shanchu(struct tongxunlu txl[],int e)				//删除主函数
{
	...
	while(1)
	{
		...
		if(xz1=='1')
		{
			...
			if(weizhi[0]==-1)
			{
				puts("没有此人");system("pause");system("cls");
			}
			if(weizhi[0]!=-1)
			{
				while(1)
				{
					...
					{
						case '1':system("cls");
								zzshanchu(txl,weizhi[0]);system("pause");system("cls");break;
						case '2':system("cls");
								sjshanchu(txl,weizhi[0]);system("pause");system("cls");break;
						case '3':system("cls");
								q=qbshanchu(txl,weizhi[0],e);system("pause");system("cls");break;
						case '0':flag++;system("cls");break;
					}
					if(flag>0)
					break;
		...
		if(xz1=='2')
		{
			...
			if(k>1)
			{
				...
				while(1)
				{
					...
					{
					case '1':system("cls");
							zzshanchu(txl,weizhi[(int)xh-49]);system("pause");system("cls");
							break;
					case '2':system("cls");
							sjshanchu(txl,weizhi[(int)xh-49]);system("pause");system("cls");
							break;
					case '3':system("cls");
							q=qbshanchu(txl,weizhi[(int)xh-49],e);system("pause");system("cls");break;
					case '0':flag++;system("cls");break;
					}
					if(flag>0)
						break;
...
void zzshanchu(struct tongxunlu *txl,int weizhi)				//住宅号码删除函数
{
	char xz;
...
void sjshanchu(struct tongxunlu *txl,int weizhi)				//手机号码删除函数
{
	int i,j;
	char *xuhao;
	char xz,queren;
...
int qbshanchu(struct tongxunlu *txl,int weizhi,int e)				//全部删除函数
{
	char xz;
	printf("是否全部删除?\ny)删除\nn)取消\n请选择:\n");
	xz=getchar();
