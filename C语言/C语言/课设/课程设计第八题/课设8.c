...
#include<stdlib.h>
char zqsr(char *c);
void diancai(char *diancai,int *geshu);
void chakan(char *diancai,int *geshu);
void tiancai(char *diancai,int *geshu);
void jiancai(char *diancai,int *geshu);
void jiesuan(char *diancai,int *geshu);
char zqsr(char *c)
{
	char xz;
	xz=getchar();
...
int main()
{
	...
	while(1)
	{
		...
		{
		case '1':system("cls");
				diancai(diancai_,geshu_);system("pause");system("cls");break;
		case '2':system("cls");
				chakan(diancai_,geshu_);system("pause");system("cls");break;
		case '3':system("cls");
				tiancai(diancai_,geshu_);system("pause");system("cls");break;
		case '4':system("cls");
				jiancai(diancai_,geshu_);system("pause");system("cls");break;
		case '5':system("cls");
				jiesuan(diancai_,geshu_);system("pause");system("cls");break;
		case '0':flag++;break;
		}
		fflush(stdin);
		if(flag>0)
